...
# Definições de função
def rolar_dado():
    rolar = randint(1, 6) # Gere um número aleatório entre 1 e 6 e armazene-o na variável 'rolar'
    print('Você rolou um', rolar, fogo * rolar) # Repita o disparar emoji para corresponder ao rolo de dados aleatório
...
def rolar_dado():   
    ...
    print('Você rolou um', rolar, fogo * rolar)
