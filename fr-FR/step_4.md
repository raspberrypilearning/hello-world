...
![Le Code Editor montre que la ligne de code à l'intérieur de la fonction `roule_de` n'a pas été indentée. La ligne de code contenant l'erreur est mise en surbrillance. Le code a été exécuté, avec l'erreur 'SyntaxError: bad input on line 17 in main.py'.](images/indent_error.png)
