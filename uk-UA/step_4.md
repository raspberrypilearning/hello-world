...
Функції повинні бути визначені до того, як ти будеш їх викликати. Шукай коментар у верхній частині вкладки **main.py**, де написано `#Помісти сюди визначення функцій`.
...
print(calendar, clock, '-', datetime.now())

roll_dice() #Виклик функції roll_dice
...
def roll_dice():    
  print(python, 'може зробити', dice)    
  roll = randint(1, 6) #Генерація випадкового числа від 1 до 6    
  print('Тобі випало число:', roll) #Отримати значення змінної roll     
  print(fire * roll) #Повторення емодзі вогню, яке відповідає результату випадіння рандомного числа
...
def roll_dice():   
  print(python, 'може зробити', dice)   
  max = input('Скільки сторін буде мати кубик?:') #Очікування на введення даних від користувача    
  print('Тип твого кубика: D', max) #Використання числа, яке ввів користувач    
  roll = randint(1, 6)    
  print('Тобі випало число:', roll)    
  print(fire * roll)
...
def roll_dice():   
  ...
  max = input('Скільки сторін буде мати кубик?:') #Очікування на введення даних від користувача   
  print('Тип твого кубика: D', max) #Використання числа, яке ввів користувач   
  roll = randint(1, int(max)) #randint повинен мати значення max, щоб бути 'цілим числом'   
  print('Тобі випало число:', roll)   
  print(fire * roll) 
