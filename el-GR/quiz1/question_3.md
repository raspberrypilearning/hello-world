...
![Στην περιοχή εξόδου του code editor εμφανίζονται οι δύο τυχαία παραγόμενοι αριθμοί.](images/quiz3.png)
...
Πολύ κοντά! `two_dice` είναι το όνομα της συνάρτησης, αλλά για να την καλέσεις χρειάζεσαι κάτι περισσότερο από το όνομα.
...
--- /code ---
 ...
 Όχι ακριβώς, σκέψου το είδος των σημείων στίξης (παρενθέσεις, αγκύλες, άγκιστρα) που χρησιμοποίησες για να καλέσεις τις συναρτήσεις στο έργο σου.
